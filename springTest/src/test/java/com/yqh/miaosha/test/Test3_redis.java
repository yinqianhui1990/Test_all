...
public class Test3_redis {
    ...
    @Autowired
    GoodsService goodServiceByRedisPositiveLockImpl;
    ...
    public void inser() {
        ...
        goodServiceByRedisPositiveLockImpl.insert(goods);
    ...
    public void buy(){
        ...
        for(int i=0;i<1000;i++) {
            new Thread(new Runnable() {
                public void run() {
                    ...
                    goods.setCode("g1");
                    goods.setAmount(6);
                    boolean res = goodServiceByRedisPositiveLockImpl.updateGoodAmount(goods);
                    if (res) {
        ...
        System.out.println("剩余货物："+goodServiceByRedisPositiveLockImpl.getGoodAmount("g1"));
    }
    @After
    public void del() {
